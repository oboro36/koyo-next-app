...
/* harmony import */ var _base_axios__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../base/axios */ "./base/axios.js");
...
class Main extends react__WEBPACK_IMPORTED_MODULE_7___default.a.Component {
  constructor(props) {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_6__["default"])(this, "getPerson", () => {
      ...
      setTimeout(() => {
        Object(_base_axios__WEBPACK_IMPORTED_MODULE_9__["invokeApi"])('post', '/alluser', res => {
          let result = res.data;
          self.setState({
            dataSource: result
          });
  ...
  render() {
    return __jsx("div", {
      ...
      __self: this
    }, "Get Data")), __jsx(antd_lib_card__WEBPACK_IMPORTED_MODULE_5___default.a, {
      __source: {
        fileName: _jsxFileName,
        lineNumber: 65
      },
